import { SignupForm } from "@/components/landing/sign-up/sign-up-form";
...
function SignupPage() {
  ...
  // Rastrear visualização da página de signup
  useEffect(() => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[var(--color-background)] via-[var(--color-neutral-50)] to-[var(--color-primary)]/10">
      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center py-20">
        <div className="w-full max-w-md md:max-w-4xl mx-auto px-6">
          <SignupForm />
        </div>
      </div>
    </div>
