...
export function SignupForm({
  ...
  const handleLoginClick = () => {
    trackCTAClick("login-link", "signup-form");
        ...
        >
          <FieldGroup>
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-center gap-4">
              <Button
                type="submit"
                className="w-full md:w-auto md:px-8 bg-[var(--color-primary)] hover:bg-[#188f6a] text-white font-semibold py-3 rounded-xl transition-all duration-300 shadow-md hover:shadow-xl hover:shadow-[var(--color-primary)]/25"
              >
                Criar Conta
              </Button>
            </div>
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-center gap-4">
              <Button
                ...
                className="w-full md:w-auto md:px-8 border-[var(--color-neutral-200)] hover:bg-[var(--color-neutral-100)] hover:border-[var(--color-neutral-300)] text-[var(--color-neutral-800)] hover:text-[var(--color-neutral-900)] font-medium py-3 rounded-xl transition-all duration-300 shadow-sm hover:shadow-md hover:shadow-[var(--color-neutral-200)]/50 group"
              >
                <svg
